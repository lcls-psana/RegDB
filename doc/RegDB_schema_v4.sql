...
-- -----------------------------------------------------
-- Table `REGDB`.`EXPERIMENT_PROPOSAL_RUN13`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `REGDB`.`EXPERIMENT_PROPOSAL_RUN13` (
  ...
  CONSTRAINT `EXPERIMENT_PROPOSAL_RUN13_FK_1`
    FOREIGN KEY (`exper_id` )
    REFERENCES `REGDB`.`EXPERIMENT` (`id` )
    ON DELETE CASCADE
    ON UPDATE CASCADE
...
-- -----------------------------------------------------
-- Table `REGDB`.`LCLS_PROPOSAL_RUN14`
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS `REGDB`.`LCLS_PROPOSAL_RUN14` (

  `proposal`      VARCHAR(32)     NOT NULL ,
