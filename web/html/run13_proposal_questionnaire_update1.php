...
<?php } ?>
    ...
    <div class="data-sect" >
      <h1>2. Offline Analysis</h1>
      <div class="comments">
        <p>The <b>psana-python</b> toolkit may also be used to analyze the data once it 
        has been written to disk.  It has the advantage that the same code works 
